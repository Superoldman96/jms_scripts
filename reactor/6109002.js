function act() {
	...
	if (em != null) {
		if (rm.getMap().getId() == 610030200) {
			rm.mapMessage(6, "The Mage Sigil has been activated!");
			...
			rm.mapMessage(6, "The Mage Sigil has been activated! You hear gears turning! The Menhir Defense System is active! Run!");
